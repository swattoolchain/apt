...
- **QPT Framework** (parent directory)
...
- **Linux**: `src-tauri/target/release/bundle/deb/qpt-desktop.deb`
...
4. Deploy to remote server (manual or via qpt)
5. Monitor status
