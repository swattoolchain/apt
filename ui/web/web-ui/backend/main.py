"""
QPT Web UI - Backend API

FastAPI backend for the QPT Web UI providing REST API and WebSocket endpoints.
"""
...
# Import QPT framework components
import sys
...
# FastAPI app
app = FastAPI(
    title="QPT Web UI API",
    description="Backend API for QPT Performance Testing Framework",
    version="1.0.0"
)
