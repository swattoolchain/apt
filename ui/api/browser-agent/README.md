...
<script src="apt-browser-agent.min.js"></script>
<script>
  const agent = new QPTBrowserAgent.QPTBrowserAgent({
    name: 'my-website',
...
```typescript
import QPTBrowserAgent from '@qpt/browser-agent';
...
## Integration with QPT Framework
